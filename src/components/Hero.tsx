      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 lg:py-14 xl:py-24 grid lg:grid-cols-2 lg:gap-12 items-center">
        <div>
          ...
          <h1 className="mt-4 text-4xl sm:text-5xl font-extrabold tracking-tight leading-tight">
            ...
            <span className="text-blue-600">online</span> více v{" "}
            <span className="text-orange-600">bezpečí</span>.
          </h1>
          <p className="mt-4 text-zinc-700 sm:text-lg text-md">
          ...
          <div className="sm:my-6 lg:mb-0 my-5 flex  sm:gap-4 gap-2 text-sm text-zinc-600">
            <div className="flex gap-2 flex-col sm:flex-row text-center sm:text-left">
              <CheckCircle2 className="h-4 w-4 sm:mt-0.5 text-emerald-600 inline-block mx-auto" />{" "}
              90-120min bloky
            </div>
            <div className="flex gap-2 flex-col sm:flex-row text-center sm:text-left">
              <CheckCircle2 className="h-4 w-4 mt-0.5 text-emerald-600 inline-block mx-auto" />{" "}
              Vhodné pro všechny{" "}
        ...
        <div className="relative">
          <div className="lg:aspect-[4/3] aspect-video rounded-2xl bg-gradient-to-br from-zinc-100 to-zinc-200 border border-zinc-200 overflow-hidden shadow-sm">
          ...
          <div className="absolute -bottom-6 sm:-left-6 -left-3 bg-white border border-zinc-200 rounded-2xl sm:p-4 p-2.5 shadow-sm flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-orange-600 text-white grid place-content-center">
              <Lock className="h-5 w-5" />
            </div>
            <div>
              <p className="font-medium text-sm sm:text-md">Praktické ukázky</p>
              <p className="sm:text-sm text-xs text-zinc-600">
